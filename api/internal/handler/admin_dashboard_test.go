...
func (r *memBookingRepo) ListByUser(ctx context.Context, userID primitive.ObjectID) ([]booking.Booking, error) {
	return r.ListConfirmedByUser(ctx, userID)
}
func (r *memBookingRepo) ListConfirmedByUser(_ context.Context, _ primitive.ObjectID) ([]booking.Booking, error) {
	return nil, nil
}
