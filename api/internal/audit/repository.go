...
type AuditRepository interface {
	...
	ListAuditLogs(ctx context.Context, page LogPage, filter AuditLogFilter) ([]AuditLog, error)
}
...
type EmailLogRepository interface {
	...
	ListEmailLogs(ctx context.Context, page LogPage, filter EmailLogFilter) ([]EmailLog, error)
}
